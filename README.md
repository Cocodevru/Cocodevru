...
Привет, меня зовут Егор, я web-разработчик и web-дизайнер, занимаюсь созданием веб-сайтов более 3-х лет. Выполняю верстку и программирование сайтов, а так же доработку, добавляя полный функционал на сайт.  Делаю адаптивную верстку, таким образом сайт получается красивым и удобным на любом устройстве, будь это компьютер или телефон.  Вы можете заказать у меня сайт любого масштаба от обычного лендинга или сайт-визитки до многостраничного сайта или интернет-магазина!
