...
Привет, меня зовут Егор, я начинающий веб-разработчик, занимаюсь созданием и разработкой веб-сайтов с нуля, под ключ более 2-х лет. Выполняю верстку и программирование сайтов, а так же доработку, добавляя полный функционал на сайт! Делаю адаптивную верстку, таким образом сайт получается красивым и удобным на любом устройстве, будь то компьютер или телефон! 
Пока, что владею: HTML5, CSS3, Sass/Scss, JavaScript - на среднем уровне, WordPress и Python - на начальном уровне. Также я изучаю: C++, PHP, Python, WordPress, Vue.js, React.js, Angular, Adobe Photoshop, Figma, Bootstrap.

На своём сайте я разместил информацию о моих навыках, мои сертификаты, работы, прайс и контакты. С нетерпением жду возможности сотрудничества с вами!
